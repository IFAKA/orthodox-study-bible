...
# Format: (month, day, service, reading_ref)
# reading_ref uses canonical verse refs e.g. "MAT-5-1"
# This is a minimal seed; a full Menaion has hundreds of entries.
MENAION_DATA: list[tuple[int, int, str, str]] = [
    (1,  1,  "matins",  "LUK-2-21"),
    (1,  6,  "matins",  "MAT-3-13"),
    (1,  7,  "matins",  "JHN-1-29"),
    (1,  14, "matins",  "MAT-4-1"),
    (2,  2,  "matins",  "LUK-2-22"),
    (2,  14, "matins",  "JHN-15-9"),
    (3,  25, "matins",  "LUK-1-26"),
    (4,  23, "matins",  "JHN-15-17"),
    (5,  21, "matins",  "JHN-17-1"),
    (6,  24, "matins",  "LUK-1-57"),
    (6,  29, "matins",  "MAT-16-13"),
    (7,  20, "matins",  "MRK-6-14"),
    (8,  6,  "matins",  "MAT-17-1"),
    (8,  15, "matins",  "LUK-10-38"),
    (8,  29, "matins",  "MRK-6-17"),
    (9,  8,  "matins",  "LUK-1-39"),
    (9,  14, "matins",  "JHN-12-28"),
    (10, 1,  "matins",  "LUK-10-16"),
    (10, 14, "matins",  "LUK-10-1"),
    (11, 21, "matins",  "LUK-10-38"),
    (12, 6,  "matins",  "LUK-6-17"),
    (12, 25, "matins",  "MAT-2-1"),
    (12, 25, "liturgy", "GAL-4-4"),
]

# ── Sample Paschal cycle ──────────────────────────────────────────────────────
# offset_days from Pascha (0 = Pascha Sunday)
PASCHAL_DATA: list[tuple[int, str, str]] = [
    (-70, "matins",  "LUK-18-10"),   # Sunday of the Publican and Pharisee
    (-63, "matins",  "LUK-15-11"),   # Sunday of the Prodigal Son
    (-56, "matins",  "MAT-25-31"),   # Meatfare Sunday
    (-49, "matins",  "MAT-6-14"),    # Cheesefare Sunday (Forgiveness)
    (-48, "matins",  "MAT-6-1"),     # Clean Monday
    (-42, "matins",  "MAT-17-1"),    # Sunday of Orthodoxy (1st Sunday of Lent)
    (-35, "matins",  "MRK-2-1"),     # 2nd Sunday of Lent
    (-28, "matins",  "MRK-8-34"),    # 3rd Sunday of Lent (Cross)
    ...
    (39,  "matins",  "ACT-1-1"),     # Ascension (Thursday)
...
def get_daily_readings(today: date | None = None) -> list[dict]:
    """Return list of {service, reading_ref, source} for today."""
    if today is None:
        today = date.today()
    ...
    for month, day, service, ref in MENAION_DATA:
    ...
    for offset_days, service, ref in PASCHAL_DATA:
